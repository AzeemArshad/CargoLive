...
var routes = [
    {
        ...
        children: [
            {
                path: 'analytics',
                loadChildren: function () { return __webpack_require__.e(/*! import() | dash-analytics-dash-analytics-module */ "dash-analytics-dash-analytics-module").then(__webpack_require__.bind(null, /*! ./dash-analytics/dash-analytics.module */ "./src/app/demo/dashboard/dash-analytics/dash-analytics.module.ts")).then(function (module) { return module.DashAnalyticsModule; }); }
            }
        ]
    }
];
