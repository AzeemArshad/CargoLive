...
var routes = [
    {
        ...
        children: [
            {
                path: 'setup',
                loadChildren: function () { return Promise.all(/*! import() | setup-setup-module */[__webpack_require__.e("default~identity-identity-module~setup-setup-module"), __webpack_require__.e("setup-setup-module")]).then(__webpack_require__.bind(null, /*! ./setup/setup.module */ "./src/app/main/setup/setup.module.ts")).then(function (module) { return module.SetupModule; }); },
            }
        ]
    }
];
