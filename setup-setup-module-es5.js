...
var CreateEditCompanyComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](CreateEditCompanyComponent, _super);
    function CreateEditCompanyComponent(injector, _processDataService) {
        var _this = _super.call(this, injector) || this;
        _this._processDataService = _processDataService;
        _this.company = new src_app_shared_dtos_identity_company_dto__WEBPACK_IMPORTED_MODULE_5__["CompanyDto"]();
        _this.phone = {};
        _this.saving = false;
        _this.itemList = [];
        _this._id = null;
    ...
    CreateEditCompanyComponent.prototype.ngOnInit = function () {
        this.phone.type = 'Email';
        this.company.comp_phones = [];
    };
    CreateEditCompanyComponent.prototype.getData = function () {
        var _this = this;
        this.itemList = [];
        this._processDataService.getData("/api/companies").subscribe(function (response) {
    ...
    CreateEditCompanyComponent.prototype.getDataById = function (event) {
        var _this = this;
        this._processDataService.getDataById("/api/companies/" + event._id).subscribe(function (response) {
            if (response.status === 1) {
                _this.company = response.data;
                _this.company.comp_phones = response.data.comp_phones;
                _this._id = event._id;
                _this.isNo = true;
            }
            else {
    ...
    CreateEditCompanyComponent.prototype.getDataByNo = function () {
        var _this = this;
        this._processDataService.getDataById("/api/companies/" + this.company.comp_no).subscribe(function (response) {
            if (response.status === 1) {
                _this.company = response.data;
                _this.company.comp_phones = response.data.comp_phones;
            }
    ...
    CreateEditCompanyComponent.prototype.getNextNo = function () {
        var _this = this;
        this._processDataService.getData("/api/nextNumber/company").subscribe(function (response) {
            if (response.status === 1) {
                _this.reset();
                _this.company.comp_no = response.data.value;
                _this.isNo = true;
            }
            else {
                _this.message.fire("Error", response.message, "error");
    ...
    CreateEditCompanyComponent.prototype.save = function (saveForm) {
        debugger;
        this.saving = true;
        var url_ = "/api/companies/";
    ...
    CreateEditCompanyComponent.prototype.create = function (url_, saveForm) {
        var _this = this;
        ...
        this._processDataService.create(url_, this.company).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["finalize"])(function () { return (_this.saving = false); })).subscribe(function (response) {
            if (response.status == 1) {
                _this.company.comp_no = response.data.item_no + 1;
    ...
    CreateEditCompanyComponent.prototype.patch = function (url_, saveForm) {
        var _this = this;
        this._processDataService.patch(url_, this.company).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["finalize"])(function () { return (_this.saving = false); })).subscribe(function (response) {
            if (response.status == 1) {
                _this.notify.success("Saved Successfully", "Success");
                saveForm.resetForm();
                _this.reset();
    ...
    CreateEditCompanyComponent.prototype.delete = function () {
        var _this = this;
        this.message.fire({
            title: 'Are you sure?',
            ...
            if (result.value) {
                _this._processDataService.delete("/api/companies/" + _this._id).subscribe(function (result) {
    ...
    CreateEditCompanyComponent.prototype.reset = function () {
        this.company = new src_app_shared_dtos_identity_company_dto__WEBPACK_IMPORTED_MODULE_5__["CompanyDto"]();
        this._id = null;
        this.isNo = false;
    };
    CreateEditCompanyComponent.ctorParameters = function () { return [
    ...
    return CreateEditCompanyComponent;
...
var LocationComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](LocationComponent, _super);
    function LocationComponent(injector, _processDataService) {
        var _this = _super.call(this, injector) || this;
        _this._processDataService = _processDataService;
        _this.typeList = ['Country', 'State', 'City'];
        _this.countries = [];
        _this.states = [];
        _this.location = new src_app_shared_dtos_setup_location_dto__WEBPACK_IMPORTED_MODULE_5__["LocationDto"]();
        _this.saving = false;
        _this.locationList = [];
        ...
        _this.location.loc_active = true;
        return _this;
    }
    LocationComponent.prototype.getData = function () {
        var _this = this;
        this.locationList = [];
        this._processDataService.getData("/api/locations").subscribe(function (response) {
            if (response.status === 1) {
                _this.locationList = response.data;
                _this.showDataModal.show(_this.tableHeaders, _this.locationList);
            }
            else {
                _this.message.fire("Error", response.message, "error");
            }
    ...
    LocationComponent.prototype.getDataById = function (event) {
        var _this = this;
        this._processDataService.getDataById("/api/locations/id/" + event._id).subscribe(function (response) {
            if (response.status === 1) {
                _this.location = response.data;
                _this._id = event._id;
                _this.isNo = true;
                _this.getLocation(_this.location.loc_type);
            }
            else {
                _this.message.fire("Error", response.message, "error");
            }
    ...
    LocationComponent.prototype.getDataByNo = function () {
        var _this = this;
        this._processDataService.getDataById("/api/locations/no/" + this.location.loc_no).subscribe(function (response) {
            if (response.status === 1) {
                _this.location = response.data;
    ...
    LocationComponent.prototype.getNextNo = function () {
        var _this = this;
        this._processDataService.getData("/api/nextNumber/Location").subscribe(function (response) {
            if (response.status === 1) {
                _this.reset();
                _this.location.loc_no = response.data.value;
                _this.isNo = true;
            }
            else {
                _this.message.fire("Error", response.message, "error");
    ...
    LocationComponent.prototype.save = function (saveForm) {
        debugger;
    ...
    LocationComponent.prototype.create = function (url_, saveForm) {
        var _this = this;
        this._processDataService.create(url_, this.location).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["finalize"])(function () { return (_this.saving = false); })).subscribe(function (response) {
            debugger;
            if (response.status == 1) {
                _this.notify.success("Saved Successfully", "Success");
                saveForm.resetForm();
    ...
    LocationComponent.prototype.patch = function (url_, saveForm) {
        var _this = this;
        this._processDataService.patch(url_, this.location).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["finalize"])(function () { return (_this.saving = false); })).subscribe(function (response) {
            if (response.status === 1) {
    ...
    LocationComponent.prototype.delete = function () {
        ...
        this.message.fire({
            ...
            if (result.value) {
                _this._processDataService.delete("/api/locations/" + _this._id).subscribe(function (result) {
                    if (result.status === 1) {
                        _this.notify.success('Deleted Successfully.', 'Deleted!');
                        _this.reset();
                    }
    ...
    LocationComponent.prototype.reset = function () {
    ...
    LocationComponent.prototype.setTypeheadList = function (param) {
        switch (param) {
            case 'type':
    ...
    LocationComponent.prototype.getLocation = function (param) {
        switch (param) {
            case 'State':
    ...
    LocationComponent.prototype.getLocationData = function (param) {
        var _this = this;
        debugger;
        this._processDataService.getData("/api/locations/" + param).subscribe(function (response) {
            debugger;
            if (response.status === 1) {
                _this.states = [];
                _this.countries = [];
                ...
                switch (param) {
                    case 'country':
                        _this.countries = itemList;
                        _this.showCountry = true;
                        break;
                    case 'state':
                        _this.states = itemList;
...
var CreateEditOfficeComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](CreateEditOfficeComponent, _super);
    function CreateEditOfficeComponent(injector, _processDataService) {
        var _this = _super.call(this, injector) || this;
        _this._processDataService = _processDataService;
        _this.office = new src_app_shared_dtos_identity_office_dto__WEBPACK_IMPORTED_MODULE_5__["OfficeDto"]();
        _this.phone = {};
        _this.saving = false;
        _this.itemList = [];
        _this._id = null;
    ...
    CreateEditOfficeComponent.prototype.ngOnInit = function () {
        this.getLocationData();
    };
    CreateEditOfficeComponent.prototype.getNextNo = function () {
        var _this = this;
        this._processDataService.getData("/api/nextNumber/office").subscribe(function (response) {
            if (response.status === 1) {
                _this.reset();
                _this.office.off_no = response.data.value;
                _this.isNo = true;
            }
            else {
                _this.message.fire("Error", response.message, "error");
    ...
    CreateEditOfficeComponent.prototype.getData = function () {
        var _this = this;
        debugger;
        this.itemList = [];
        this._processDataService.getData("/api/offices").subscribe(function (response) {
            if (response.status === 1) {
                _this.itemList = response.data;
                _this.showDataModal.show(_this.tableHeaders, _this.itemList);
            }
    ...
    CreateEditOfficeComponent.prototype.getDataById = function (event) {
        var _this = this;
        this._processDataService.getDataById("/api/offices/" + event._id).subscribe(function (response) {
            if (response.status === 1) {
                _this.office = response.data;
                _this.contactDetail.contacts = response.data.off_phones;
                _this._id = event._id;
                _this.isNo = true;
            }
            else {
    ...
    CreateEditOfficeComponent.prototype.getDataByNo = function () {
        var _this = this;
        this._processDataService.getDataById("/api/offices/" + this.office.off_no).subscribe(function (response) {
            if (response.status === 1) {
                _this.office = response.data;
                _this.contactDetail.contacts = response.data.off_phones;
            }
    ...
    CreateEditOfficeComponent.prototype.create = function (url_, saveForm) {
        var _this = this;
        ...
        this._processDataService.create(url_, this.office).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["finalize"])(function () { return (_this.saving = false); })).subscribe(function (response) {
            if (response.status == 1) {
                _this.notify.success("Saved Successfully", "Success");
                saveForm.resetForm();
                _this.reset();
    ...
    CreateEditOfficeComponent.prototype.patch = function (url_, saveForm) {
        var _this = this;
        this._processDataService.patch(url_, this.office).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["finalize"])(function () { return (_this.saving = false); })).subscribe(function (response) {
            if (response.status === 1) {
                _this.notify.success("Update Successfully", "Success");
                saveForm.resetForm();
                _this.reset();
    ...
    CreateEditOfficeComponent.prototype.delete = function () {
        var _this = this;
        this.message.fire({
            title: 'Are you sure?',
            html: 'You are about to delete 1 record permanently.',
            ...
            if (result.value) {
                _this._processDataService.delete("/api/offices/" + _this._id).subscribe(function (response) {
                    if (response.status === 1) {
                        _this.notify.success('Deleted Successfully.', 'Deleted!');
                        _this.reset();
                    }
    ...
    CreateEditOfficeComponent.prototype.reset = function () {
        this.office = new src_app_shared_dtos_identity_office_dto__WEBPACK_IMPORTED_MODULE_5__["OfficeDto"]();
        this._id = null;
        this.isNo = false;
    };
    CreateEditOfficeComponent.prototype.setTypeheadList = function (param) {
        switch (param) {
            case 'city':
    ...
    CreateEditOfficeComponent.prototype.getLocationData = function () {
        var _this = this;
        this._processDataService.getData("/api/locations/city").subscribe(function (response) {
            debugger;
            _this.cities = [];
            if (response.status === 1) {
                response.data.forEach(function (loc) {
    ...
    CreateEditOfficeComponent.ctorParameters = function () { return [
        { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Injector"] },
        { type: src_app_shared_services_identity_service__WEBPACK_IMPORTED_MODULE_6__["IdentityService"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    return CreateEditOfficeComponent;
}(src_app_shared_common_app_component_base__WEBPACK_IMPORTED_MODULE_3__["AppComponentBase"]));
...
var CreateEditStaffComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](CreateEditStaffComponent, _super);
    function CreateEditStaffComponent(injector, _processDataService) {
        var _this = _super.call(this, injector) || this;
        _this._processDataService = _processDataService;
        _this.staff = new src_app_shared_dtos_identity_staff_dto__WEBPACK_IMPORTED_MODULE_5__["StaffDto"]();
        _this.phone = {};
        _this.saving = false;
        _this.itemList = [];
        _this._id = null;
    ...
    CreateEditStaffComponent.prototype.getData = function () {
        var _this = this;
        debugger;
        this.itemList = [];
        this._processDataService.getData("/api/staffs").subscribe(function (response) {
            if (response.status === 1) {
                _this.itemList = response.data;
                _this.showDataModal.show(_this.tableHeaders, _this.itemList);
            }
    ...
    CreateEditStaffComponent.prototype.getDataById = function (event) {
        var _this = this;
        this._processDataService.getDataById("/api/staffs/" + event._id).subscribe(function (response) {
            if (response.status === 1) {
                _this.staff = response.data;
                _this.contactDetail.contacts = response.data.stf_contacts;
                _this._id = event._id;
                _this.isNo = true;
            }
            else {
    ...
    CreateEditStaffComponent.prototype.getNextNo = function () {
        var _this = this;
        this._processDataService.getData("/api/nextNumber/staff").subscribe(function (response) {
            if (response.status === 1) {
                _this.reset();
                _this.staff.stf_no = response.data.value;
                _this.isNo = true;
            }
            else {
                _this.message.fire("Error", response.message, "error");
    ...
    CreateEditStaffComponent.prototype.getDataByNo = function () {
        var _this = this;
        this._processDataService.getDataById("/api/staffs/" + this.staff.stf_no).subscribe(function (response) {
            if (response.status === 1) {
                _this.staff = response.data;
                _this.contactDetail.contacts = response.data.stf_contacts;
            }
    ...
    CreateEditStaffComponent.prototype.save = function (saveForm) {
        debugger;
        this.saving = true;
    ...
    CreateEditStaffComponent.prototype.create = function (url_, saveForm) {
        var _this = this;
        this._processDataService.create(url_, this.staff).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["finalize"])(function () { return (_this.saving = false); })).subscribe(function (response) {
            if (response.status == 1) {
                _this.notify.success("Saved Successfully", "Success");
                saveForm.resetForm();
                _this.reset();
    ...
    CreateEditStaffComponent.prototype.patch = function (url_, saveForm) {
        var _this = this;
        this._processDataService.patch(url_, this.staff).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["finalize"])(function () { return (_this.saving = false); })).subscribe(function (response) {
            if (response.status === 1) {
                _this.notify.success("Update Successfully", "Success");
                saveForm.resetForm();
                _this.reset();
    ...
    CreateEditStaffComponent.prototype.delete = function () {
        var _this = this;
        this.message.fire({
            title: 'Are you sure?',
            html: 'You are about to delete 1 record permanently.',
            ...
            if (result.value) {
                _this._processDataService.delete("/api/staffs/" + _this._id).subscribe(function (result) {
                    if (result.status === 1) {
                        _this.notify.success('Deleted Successfully.', 'Deleted!');
                        _this.reset();
                    }
    ...
    CreateEditStaffComponent.prototype.reset = function () {
    ...
    CreateEditStaffComponent.ctorParameters = function () { return [
        { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Injector"] },
        { type: src_app_shared_services_identity_service__WEBPACK_IMPORTED_MODULE_6__["IdentityService"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
var CreateEditAccountTypeComponent = /** @class */ (function () {
    function CreateEditAccountTypeComponent() {
    }
    CreateEditAccountTypeComponent.prototype.ngOnInit = function () {
    };
    ...
    return CreateEditAccountTypeComponent;
}());
...
var ARAgingComponent = /** @class */ (function () {
    function ARAgingComponent() {
    }
    ARAgingComponent.prototype.ngOnInit = function () {
    };
...
var CreateEditBankComponent = /** @class */ (function () {
    function CreateEditBankComponent() {
    }
    CreateEditBankComponent.prototype.ngOnInit = function () {
    };
    ...
    return CreateEditBankComponent;
}());
...
var CreateEditBiltyExpenseComponent = /** @class */ (function () {
    function CreateEditBiltyExpenseComponent() {
    }
    CreateEditBiltyExpenseComponent.prototype.ngOnInit = function () {
    };
    ...
    return CreateEditBiltyExpenseComponent;
}());
...
var CreateEditBiltyComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](CreateEditBiltyComponent, _super);
    function CreateEditBiltyComponent(injector, _processDataService) {
        var _this = _super.call(this, injector) || this;
        _this._processDataService = _processDataService;
        _this.btModelList = ['Retail', 'LCL', 'FCL'];
        _this.btModeList = ['Regular', 'Godown'];
        _this.btTypeList = ['Book', 'Deliver', 'Return'];
        _this.btPaymodeList = ['To-Pay', 'Paid'];
        _this.billtiesDtoList = [];
        _this.billtiesDto = new src_app_shared_dtos_identity_bilities_dto__WEBPACK_IMPORTED_MODULE_5__["BilltiesDto"]();
        _this.itemPackListDto = [];
        _this.itemPackDto = {};
        _this.saving = false;
        _this.itemList = [];
        _this._id = null;
    ...
    CreateEditBiltyComponent.prototype.ngOnInit = function () {
        this.insertBiltyItem();
    };
    CreateEditBiltyComponent.prototype.getData = function () {
        var _this = this;
        this.billtiesDtoList = [];
        this._processDataService.getData("/api/billties").subscribe(function (response) {
            if (response.status === 1) {
                _this.billtiesDtoList = response.data;
                _this.showDataModal.show(_this.tableHeaders, _this.itemList);
            }
            else {
                _this.message.fire("Error", response.message, "error");
    ...
    CreateEditBiltyComponent.prototype.getDataById = function (event) {
        var _this = this;
        this._processDataService.getDataById("/api/billties/" + event._id).subscribe(function (response) {
            if (response.status === 1) {
                _this.billtiesDto = response.data;
                _this.itemPackListDto = _this.billtiesDto.bt_items;
                _this._id = event._id;
            }
            else {
                _this.message.fire("Error", response.message, "error");
    ...
    CreateEditBiltyComponent.prototype.getDataByNo = function () {
        var _this = this;
        this._processDataService.getDataById("/api/billties/" + this.billtiesDto.bt_no).subscribe(function (response) {
            if (response.status === 1) {
                _this.billtiesDto = response.data;
                _this.isNo = true;
                _this.itemPackListDto = _this.billtiesDto.bt_items;
    ...
    CreateEditBiltyComponent.prototype.getNextNo = function () {
        var _this = this;
        this._processDataService.getData("/api/nextNumber/bilty").subscribe(function (response) {
            if (response.status === 1) {
                _this.reset();
                _this.billtiesDto.bt_no = response.data.value;
                _this.isNo = true;
            }
            else {
                _this.message.fire("Error", response.message, "error");
    ...
    CreateEditBiltyComponent.prototype.save = function (saveForm) {
        debugger;
        this.saving = true;
        var url_ = "/api/billties/";
        if (!Object(util__WEBPACK_IMPORTED_MODULE_7__["isNullOrUndefined"])(this._id)) {
    ...
    CreateEditBiltyComponent.prototype.create = function (url_, saveForm) {
        var _this = this;
        this.billtiesDto.bt_items = this.itemPackListDto;
        this._processDataService.create(url_, this.billtiesDto).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["finalize"])(function () { return (_this.saving = false); })).subscribe(function (response) {
            if (response.status === 1) {
                _this.notify.success("Saved Successfully", "Success");
                saveForm.resetForm();
            }
    ...
    CreateEditBiltyComponent.prototype.patch = function (url_, saveForm) {
        var _this = this;
        this._processDataService.patch(url_, this.billtiesDto).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["finalize"])(function () { return (_this.saving = false); })).subscribe(function (response) {
            if (response.status === 1) {
                _this.notify.success("Update Successfully", "Success");
                saveForm.resetForm();
                _this.reset();
    ...
    CreateEditBiltyComponent.prototype.insertBiltyItem = function () {
        var itempack = {};
    ...
    CreateEditBiltyComponent.prototype.deleteBiltyItem = function (index) {
        this.itemPackListDto.splice(index, 1);
    };
    CreateEditBiltyComponent.prototype.setTypeheadList = function (param) {
        switch (param) {
            case 'btModel':
    ...
    CreateEditBiltyComponent.prototype.delete = function () {
        var _this = this;
        this.message.fire({
            title: 'Are you sure?',
            html: 'You are about to delete 1 record permanently.',
            ...
            if (result.value) {
                _this._processDataService.delete("/api/bilty/" + _this._id).subscribe(function (result) {
                    if (result.status === 1) {
                        _this.notify.success('Deleted Successfully.', 'Deleted!');
                        _this.reset();
                    }
    ...
    CreateEditBiltyComponent.prototype.reset = function () {
        this.billtiesDto = new src_app_shared_dtos_identity_bilities_dto__WEBPACK_IMPORTED_MODULE_5__["BilltiesDto"]();
        this._id = null;
        this.isNo = false;
    };
    CreateEditBiltyComponent.ctorParameters = function () { return [
        { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Injector"] },
        { type: src_app_shared_services_identity_service__WEBPACK_IMPORTED_MODULE_6__["IdentityService"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    return CreateEditBiltyComponent;
}(src_app_shared_common_app_component_base__WEBPACK_IMPORTED_MODULE_3__["AppComponentBase"]));
...
var CreateEditBookingBillTComponent = /** @class */ (function () {
    function CreateEditBookingBillTComponent() {
    }
    CreateEditBookingBillTComponent.prototype.ngOnInit = function () {
    };
    ...
    return CreateEditBookingBillTComponent;
}());
...
var CreateEditBookingVoucherComponent = /** @class */ (function () {
    function CreateEditBookingVoucherComponent() {
    }
    CreateEditBookingVoucherComponent.prototype.ngOnInit = function () {
    };
    ...
    return CreateEditBookingVoucherComponent;
}());
...
var CreateEditChallanComponent = /** @class */ (function () {
    function CreateEditChallanComponent() {
    }
    CreateEditChallanComponent.prototype.ngOnInit = function () {
    };
    ...
    return CreateEditChallanComponent;
}());
...
var CreateEditContractComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](CreateEditContractComponent, _super);
    function CreateEditContractComponent(injector, _processDataService) {
        var _this = _super.call(this, injector) || this;
        _this._processDataService = _processDataService;
        _this.cnModeList = ['None', 'All', 'LCL', 'FCL'];
        _this.Contract = new src_app_shared_dtos_identity_contract_dto__WEBPACK_IMPORTED_MODULE_5__["ContractDto"]();
        _this.rateListDto = [];
        _this.saving = false;
        _this.contractList = [];
        _this.uoms = [];
        ...
        _this.Contract.cn_cbm = false;
        return _this;
    }
    CreateEditContractComponent.prototype.ngOnInit = function () {
        this.Contract.cn_cbm = false;
        this.insertRateItem();
        this.getUOM();
    };
    CreateEditContractComponent.prototype.insertRateItem = function () {
        var itempack = {};
    ...
    //Delete dynamic grid row
    CreateEditContractComponent.prototype.deleteRateItem = function (index) {
        this.rateListDto.splice(index, 1);
    };
    CreateEditContractComponent.prototype.getUOM = function () {
        var _this = this;
        debugger;
    ...
    CreateEditContractComponent.prototype.getData = function () {
        var _this = this;
        this.contractList = [];
        this._processDataService.getData("/api/contracts").subscribe(function (response) {
            if (response.status === 1) {
                _this.contractList = response.data;
                _this.showDataModal.show(_this.tableHeaders, _this.contractList);
            }
            else {
                _this.message.fire("Error", response.message, "error");
            }
    ...
    CreateEditContractComponent.prototype.getDataById = function (event) {
        var _this = this;
        this._processDataService.getDataById("/api/contracts/id/" + event._id).subscribe(function (response) {
            if (response.status === 1) {
    ...
    CreateEditContractComponent.prototype.getDataByNo = function () {
        var _this = this;
        this._processDataService.getDataById("/api/contracts/no/" + this.Contract.cn_no).subscribe(function (response) {
            if (response.status === 1) {
                _this.Contract = response.data;
                _this._id = response.data._id;
                _this.isNo = true;
    ...
    CreateEditContractComponent.prototype.getNextNo = function () {
        var _this = this;
        this._processDataService.getData("/api/nextNumber/contract").subscribe(function (response) {
            if (response.status === 1) {
                _this.reset();
                _this.Contract.cn_no = response.data.value;
                _this.isNo = true;
            }
            else {
                _this.message.fire("Error", response.message, "error");
    ...
    CreateEditContractComponent.prototype.save = function (saveForm) {
        this.Contract.cn_intra_ct = this.rateListDto;
        this.saving = true;
        console.log(this.Contract);
        var url_ = "/api/contracts";
        if (!Object(util__WEBPACK_IMPORTED_MODULE_7__["isNullOrUndefined"])(this._id)) {
    ...
    CreateEditContractComponent.prototype.create = function (url_, saveForm) {
        var _this = this;
        this._processDataService.create(url_, this.Contract).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["finalize"])(function () { return (_this.saving = false); })).subscribe(function (response) {
            debugger;
            if (response.status == 1) {
                _this.Contract.cn_no = response.data.cn_no + 1;
                _this.notify.success("Saved Successfully", "Success");
                saveForm.resetForm();
                _this.reset();
            }
    ...
    CreateEditContractComponent.prototype.patch = function (url_, saveForm) {
        var _this = this;
        this._processDataService.patch(url_, this.Contract).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["finalize"])(function () { return (_this.saving = false); })).subscribe(function (response) {
            if (response.status === 1) {
                _this.notify.success("Update Successfully", "Success");
                saveForm.resetForm();
                _this.reset();
    ...
    CreateEditContractComponent.prototype.delete = function () {
        var _this = this;
        this.message.fire({
            title: 'Are you sure?',
            html: 'You are about to delete 1 record permanently.',
            ...
            if (result.value) {
                _this._processDataService.delete("/api/contracts/" + _this._id).subscribe(function (result) {
                    if (result.status === 1) {
                        _this.notify.success('Deleted Successfully.', 'Deleted!');
                        _this.reset();
                    }
    ...
    CreateEditContractComponent.prototype.reset = function () {
        this.Contract = new src_app_shared_dtos_identity_contract_dto__WEBPACK_IMPORTED_MODULE_5__["ContractDto"]();
        this._id = null;
        this.isNo = false;
    };
    CreateEditContractComponent.prototype.setTypeheadList = function (param) {
        switch (param) {
            case 'cnType':
    ...
    CreateEditContractComponent.ctorParameters = function () { return [
        { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Injector"] },
        { type: src_app_shared_services_identity_service__WEBPACK_IMPORTED_MODULE_6__["IdentityService"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    return CreateEditContractComponent;
}(src_app_shared_common_app_component_base__WEBPACK_IMPORTED_MODULE_3__["AppComponentBase"]));
...
var CreateEditInvoiceOpeningComponent = /** @class */ (function () {
    function CreateEditInvoiceOpeningComponent() {
    }
    CreateEditInvoiceOpeningComponent.prototype.ngOnInit = function () {
    };
    ...
    return CreateEditInvoiceOpeningComponent;
}());
...
var CreateEditInvoiceComponent = /** @class */ (function () {
    function CreateEditInvoiceComponent() {
    }
    CreateEditInvoiceComponent.prototype.ngOnInit = function () {
    };
    ...
    return CreateEditInvoiceComponent;
}());
...
var CreateEditPortComponent = /** @class */ (function () {
    function CreateEditPortComponent() {
    }
    CreateEditPortComponent.prototype.ngOnInit = function () {
    };
    ...
    return CreateEditPortComponent;
}());
...
var CreateEditReceivingBillToBillComponent = /** @class */ (function () {
    function CreateEditReceivingBillToBillComponent() {
    }
    CreateEditReceivingBillToBillComponent.prototype.ngOnInit = function () {
    };
    ...
    return CreateEditReceivingBillToBillComponent;
}());
...
var CreateEditShipperComponent = /** @class */ (function () {
    function CreateEditShipperComponent() {
    }
    CreateEditShipperComponent.prototype.ngOnInit = function () {
    };
    ...
    return CreateEditShipperComponent;
}());
...
var CreateEditShippinglineComponent = /** @class */ (function () {
    function CreateEditShippinglineComponent() {
    }
    CreateEditShippinglineComponent.prototype.ngOnInit = function () {
    };
    ...
    return CreateEditShippinglineComponent;
}());
...
var CreateEditTransporterComponent = /** @class */ (function () {
    function CreateEditTransporterComponent() {
    }
    CreateEditTransporterComponent.prototype.ngOnInit = function () {
    };
    ...
    return CreateEditTransporterComponent;
}());
...
var CreateEditUOMComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](CreateEditUOMComponent, _super);
    function CreateEditUOMComponent(injector, _processDataService) {
        var _this = _super.call(this, injector) || this;
        _this._processDataService = _processDataService;
        _this.Uom = new src_app_shared_dtos_identity_uom_dto__WEBPACK_IMPORTED_MODULE_5__["UOMDto"]();
        _this.saving = false;
        _this.uomList = [];
        _this._id = null;
        _this.isNo = false;
    ...
    CreateEditUOMComponent.prototype.ngOnInit = function () {
    };
    CreateEditUOMComponent.prototype.getData = function () {
        var _this = this;
        debugger;
        this.uomList = [];
        this._processDataService.getData("/api/uoms").subscribe(function (response) {
            if (response.status === 1) {
                _this.uomList = response.data;
                _this.showDataModal.show(_this.tableHeaders, _this.uomList);
            }
            else {
                _this.message.fire("Error", response.message, "error");
            }
    ...
    CreateEditUOMComponent.prototype.getDataById = function (event) {
        var _this = this;
        debugger;
        this._processDataService.getDataById("/api/getUom/" + event._id).subscribe(function (response) {
            if (response.status === 1) {
                _this.Uom = response.data;
                _this._id = event._id;
                _this.isNo = true;
            }
            else {
    ...
    CreateEditUOMComponent.prototype.save = function (CreateEditForm) {
        var _this = this;
        debugger;
        this.saving = true;
        var url_ = "/api/createUom";
        if (!Object(util__WEBPACK_IMPORTED_MODULE_7__["isNullOrUndefined"])(this._id)) {
            url_ = "/api/updateUom/" + this._id;
        }
        this._processDataService.create(url_, this.Uom).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["finalize"])(function () { return (_this.saving = false); })).subscribe(function (response) {
            _this.notify.success("Saved Successfully", "Success");
            CreateEditForm.resetForm();
            _this._id = null;
        });
    };
    CreateEditUOMComponent.prototype.getDataByNo = function () {
        var _this = this;
        this._processDataService.getDataById("/api/Uom/no/" + this.Uom.UomOrdering).subscribe(function (response) {
            if (response.status === 1) {
                _this.Uom = response.data;
                _this._id = response.data._id;
                _this.isNo = true;
    ...
    CreateEditUOMComponent.prototype.getNextNo = function () {
        var _this = this;
        this._processDataService.getData("/api/nextNumber/Uom").subscribe(function (response) {
            if (response.status === 1) {
                _this.reset();
                _this.Uom.UomOrdering = response.data.value;
                _this.isNo = true;
            }
            else {
                _this.message.fire("Error", response.message, "error");
    ...
    CreateEditUOMComponent.prototype.delete = function () {
        var _this = this;
        this.message.fire({
            title: 'Are you sure?',
            html: 'You are about to delete 1 record permanently.',
            ...
            if (result.value) {
                _this._processDataService.delete("/api/deleteUom/" + _this._id).subscribe(function (result) {
                    _this.notify.success('Deleted Successfully.', 'Deleted!');
                    _this.Uom = new src_app_shared_dtos_identity_uom_dto__WEBPACK_IMPORTED_MODULE_5__["UOMDto"]();
                    _this._id = null;
                });
    ...
    CreateEditUOMComponent.prototype.reset = function () {
        this.Uom = new src_app_shared_dtos_identity_uom_dto__WEBPACK_IMPORTED_MODULE_5__["UOMDto"]();
        this._id = null;
        this.isNo = false;
    };
    CreateEditUOMComponent.ctorParameters = function () { return [
        { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Injector"] },
        { type: src_app_shared_services_identity_service__WEBPACK_IMPORTED_MODULE_6__["IdentityService"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
var CreateEditVendorComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](CreateEditVendorComponent, _super);
    function CreateEditVendorComponent(injector, _processDataService) {
        var _this = _super.call(this, injector) || this;
        _this._processDataService = _processDataService;
        _this.vendorTypeList = ['Individual', 'Company', 'Open-Market'];
        _this.vendorTermList = ['No-Contract', 'On-Contract'];
        _this.vendorserviceList = ['Labor', 'Transport', 'Forwarding', 'Booking-Agent', 'Port', 'Shipping-Line', 'Media', 'Food',
            'Import', 'Export', 'Maintenance', 'Media', 'Marketing'];
        _this.vendorDesignation = ['Owner', 'Chairman', 'MD', 'President', 'EVP', 'SVP', 'VP', 'GM', 'Director', 'Senior Manager', 'Manager', 'Executive', 'Accountant', 'Clerk', 'Driver', 'Assistant', 'Loader', 'Labor'];
        _this.vendor = new src_app_shared_dtos_identity_vendor_dto__WEBPACK_IMPORTED_MODULE_5__["VendorDto"]();
        _this.contactDetail = {};
        _this.officeDetail = {};
        _this.vendorContact = {};
        _this.vendorOffice = {};
    ...
    CreateEditVendorComponent.prototype.ngOnInit = function () {
    ...
    CreateEditVendorComponent.prototype.getData = function () {
        var _this = this;
        this.VendorList = [];
        this._processDataService.getData("/api/vendors").subscribe(function (response) {
            debugger;
            if (response.message = "Success") {
                _this.VendorList = response.data;
                _this.showDataModal.show(_this.tableHeaders, _this.VendorList);
            }
        });
    };
    CreateEditVendorComponent.prototype.getDataById = function (event) {
        var _this = this;
        this._processDataService.getDataById("/api/vendors/" + event._id).subscribe(function (response) {
            _this.vendor = response.data;
            _this._id = event._id;
        });
    };
    CreateEditVendorComponent.prototype.getDataByNo = function () {
        var _this = this;
        this._processDataService.getDataById("/api/vendor/no/" + this.vendor.vend_no).subscribe(function (response) {
            if (response.status === 1) {
                _this.vendor = response.data;
                _this._id = response.data._id;
                _this.isNo = true;
    ...
    CreateEditVendorComponent.prototype.getNextNo = function () {
        var _this = this;
        this._processDataService.getData("/api/nextNumber/vendor").subscribe(function (response) {
            if (response.status === 1) {
                _this.reset();
                _this.vendor.vend_no = response.data.value;
                _this.isNo = true;
            }
            else {
                _this.message.fire("Error", response.message, "error");
    ...
    CreateEditVendorComponent.prototype.save = function (saveForm) {
        this.saving = true;
        debugger;
    ...
    CreateEditVendorComponent.prototype.create = function (url_, saveForm) {
        var _this = this;
        this._processDataService.create(url_, this.vendor).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["finalize"])(function () { return (_this.saving = false); })).subscribe(function (response) {
            debugger;
            if (response.status == 1) {
                _this.notify.success("Saved Successfully", "Success");
                saveForm.resetForm();
    ...
    CreateEditVendorComponent.prototype.patch = function (url_, saveForm) {
        var _this = this;
        this._processDataService.patch(url_, this.vendor).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["finalize"])(function () { return (_this.saving = false); })).subscribe(function (response) {
            if (response.status === 1) {
                _this.notify.success("Update Successfully", "Success");
                saveForm.resetForm();
                _this.reset();
    ...
    CreateEditVendorComponent.prototype.delete = function () {
        var _this = this;
        this.message.fire({
            title: 'Are you sure?',
            html: 'You are about to delete 1 record permanently.',
            ...
            if (result.value) {
                _this._processDataService.delete("/api/vendors/" + _this._id).subscribe(function (result) {
                    _this.notify.success('Deleted Successfully.', 'Deleted!');
                    _this.vendor = new src_app_shared_dtos_identity_vendor_dto__WEBPACK_IMPORTED_MODULE_5__["VendorDto"]();
                    _this._id = null;
                });
    ...
    CreateEditVendorComponent.prototype.setTypeheadList = function (param) {
        switch (param) {
            case 'type':
    ...
    CreateEditVendorComponent.prototype.reset = function () {
        this.vendor = new src_app_shared_dtos_identity_vendor_dto__WEBPACK_IMPORTED_MODULE_5__["VendorDto"]();
        this._id = null;
        this.isNo = false;
    };
    CreateEditVendorComponent.ctorParameters = function () { return [
        { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Injector"] },
        { type: src_app_shared_services_identity_service__WEBPACK_IMPORTED_MODULE_6__["IdentityService"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    return CreateEditVendorComponent;
}(src_app_shared_common_app_component_base__WEBPACK_IMPORTED_MODULE_3__["AppComponentBase"]));
...
var CreateEditVoucherComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](CreateEditVoucherComponent, _super);
    function CreateEditVoucherComponent(injector, _processDataService) {
        var _this = _super.call(this, injector) || this;
        _this._processDataService = _processDataService;
        _this.vcModelList = ['Retail', 'LCL', 'FCL'];
        _this.vcTypeList = ['Book', 'Deliver', 'Return'];
        _this.vcPaymode = ['To-Pay', 'Paid'];
        _this.Voucher = new src_app_shared_dtos_identity_voucher_dto__WEBPACK_IMPORTED_MODULE_5__["VoucherDto"]();
        _this.vehicleInfoListDto = {};
        _this.vehicleInfoDto = {};
        _this.vehicleLoaderListDto = {};
        _this.loaderInfoDto = {};
        _this.saving = false;
        _this.voucherList = [];
        _this.uoms = [];
    ...
    CreateEditVoucherComponent.prototype.ngOnInit = function () {
        this.getUOM();
    };
    CreateEditVoucherComponent.prototype.getUOM = function () {
        var _this = this;
        this._processDataService.getData("/api/uoms").subscribe(function (response) {
            if (response.status === 1) {
                _this.uoms = response.data;
    ...
    CreateEditVoucherComponent.prototype.getData = function () {
        var _this = this;
        this.voucherList = [];
        this._processDataService.getData("/api/vouchers").subscribe(function (response) {
            if (response.status === 1) {
    ...
    CreateEditVoucherComponent.prototype.getDataById = function (event) {
        var _this = this;
        this._processDataService.getDataById("/api/vouchers/id/" + event._id).subscribe(function (response) {
            if (response.status === 1) {
    ...
    CreateEditVoucherComponent.prototype.getDataByNo = function () {
        var _this = this;
        this._processDataService.getDataById("/api/vouchers/no/" + this.Voucher.vc_no).subscribe(function (response) {
            if (response.status === 1) {
                _this.Voucher = response.data;
                _this._id = response.data._id;
                _this.isNo = true;
    ...
    CreateEditVoucherComponent.prototype.getNextNo = function () {
        var _this = this;
        this._processDataService.getData("/api/nextNumber/voucher").subscribe(function (response) {
            if (response.status === 1) {
                _this.reset();
                _this.Voucher.vc_no = response.data.value;
                _this.isNo = true;
            }
            else {
                _this.message.fire("Error", response.message, "error");
    ...
    CreateEditVoucherComponent.prototype.create = function (url_, saveForm) {
        var _this = this;
        this._processDataService.create(url_, this.Voucher).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["finalize"])(function () { return (_this.saving = false); })).subscribe(function (response) {
            debugger;
            if (response.status == 1) {
                _this.Voucher.vc_no = response.data.voucher_no + 1;
                _this.notify.success("Saved Successfully", "Success");
                saveForm.resetForm();
                _this.reset();
            }
    ...
    CreateEditVoucherComponent.prototype.patch = function (url_, saveForm) {
        var _this = this;
        this._processDataService.patch(url_, this.Voucher).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["finalize"])(function () { return (_this.saving = false); })).subscribe(function (response) {
            if (response.status === 1) {
                _this.notify.success("Update Successfully", "Success");
                saveForm.resetForm();
                _this.reset();
    ...
    CreateEditVoucherComponent.prototype.delete = function () {
        var _this = this;
        this.message.fire({
            title: 'Are you sure?',
            html: 'You are about to delete 1 record permanently.',
            ...
            if (result.value) {
                _this._processDataService.delete("/api/vouchers/" + _this._id).subscribe(function (result) {
                    if (result.status === 1) {
                        _this.notify.success('Deleted Successfully.', 'Deleted!');
                        _this.reset();
                    }
    ...
    CreateEditVoucherComponent.prototype.reset = function () {
        this.Voucher = new src_app_shared_dtos_identity_voucher_dto__WEBPACK_IMPORTED_MODULE_5__["VoucherDto"]();
        this._id = null;
        this.isNo = false;
    };
    CreateEditVoucherComponent.prototype.setTypeheadList = function (param) {
        switch (param) {
            case 'vcModel':
    ...
    CreateEditVoucherComponent.ctorParameters = function () { return [
        { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Injector"] },
        { type: src_app_shared_services_identity_service__WEBPACK_IMPORTED_MODULE_6__["IdentityService"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    return CreateEditVoucherComponent;
}(src_app_shared_common_app_component_base__WEBPACK_IMPORTED_MODULE_3__["AppComponentBase"]));
...
var BilltiesDto = /** @class */ (function () {
    function BilltiesDto() {
    }
    return BilltiesDto;
}());
...
var ContractDto = /** @class */ (function () {
...
var SetupService = /** @class */ (function () {
    function SetupService(_router, http) {
    ...
    SetupService.prototype.getData = function (endPoint) {
        var _this = this;
    ...
    SetupService.prototype.getDataById = function (endPoint) {
        var _this = this;
        var url_ = this.baseUrl + endPoint;
        url_ = url_.replace(/[?&]$/, "");
        var options_ = {
    ...
    SetupService.prototype.processGetData = function (response) {
        var _this = this;
        var e_1, _a;
     ...
     * @return Success
     */
    SetupService.prototype.delete = function (endPoint) {
        var _this = this;
        var url_ = this.baseUrl + endPoint;
        url_ = url_.replace(/[?&]$/, "");
        var options_ = {
    ...
    SetupService.prototype.processDelete = function (response) {
        var _this = this;
        var e_2, _a;
        var status = response.status;
        var responseBlob = response instanceof _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpResponse"] ? response.body :
    ...
    * @return Success
    */
    SetupService.prototype.create = function (endPoint, input) {
        var _this = this;
        debugger;
        var url_ = this.baseUrl + endPoint;
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    SetupService.prototype.patch = function (endPoint, input) {
        var _this = this;
        debugger;
        var url_ = this.baseUrl + endPoint;
        url_ = url_.replace(/[?&]$/, "");
    ...
    SetupService.prototype.processCreateOrEdit = function (response) {
        var _this = this;
        var e_3, _a;
        var status = response.status;
        var responseBlob = response instanceof _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpResponse"] ? response.body :
     ...
     * @return Success
     */
    SetupService.prototype.uploadFile = function (endPoint, input) {
        var url_ = this.baseUrl + endPoint;
        url_ = url_.replace(/[?&]$/, "");
    ...
    SetupService.prototype.sessionExpired = function () {
        localStorage.clear();
        this._router.navigate(["/auth/signin"]);
        localStorage.setItem("expiryMsg", "Session expired please signin again, Thank you.");
    };
    SetupService.prototype.throwException = function (message, status, response, headers, result) {
        if (result !== null && result !== undefined)
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["throwError"])(result);
    };
    SetupService.prototype.blobToText = function (blob) {
    ...
    SetupService.ctorParameters = function () { return [
