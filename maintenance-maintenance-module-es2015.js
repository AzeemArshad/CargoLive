...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: 'error',
                loadChildren: () => __webpack_require__.e(/*! import() | mainten-error-mainten-error-module */ "mainten-error-mainten-error-module").then(__webpack_require__.bind(null, /*! ./mainten-error/mainten-error.module */ "./src/app/maintenance/mainten-error/mainten-error.module.ts")).then(module => module.MaintenErrorModule)
            }
        ]
    }
];
