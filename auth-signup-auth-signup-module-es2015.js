...
let AuthSignupComponent = class AuthSignupComponent extends src_app_shared_common_app_component_base__WEBPACK_IMPORTED_MODULE_3__["AppComponentBase"] {
    constructor(injector, _userSigninService) {
        super(injector);
        this._userSigninService = _userSigninService;
        this.user = new src_app_shared_dtos_auth_signin_dto__WEBPACK_IMPORTED_MODULE_4__["SigninDto"]();
        this.saving = false;
    }
    ngOnInit() {
    ...
    signup(signForm) {
        ...
        this.saving = true;
        this._userSigninService.SigninUser("/api/register", this.user).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["finalize"])(() => (this.saving = false))).subscribe(response => {
