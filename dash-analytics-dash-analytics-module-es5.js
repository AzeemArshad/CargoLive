...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _fack_db_chart_data__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../fack-db/chart-data */ "./src/app/fack-db/chart-data.ts");
/* harmony import */ var _theme_shared_components_chart_apex_chart_apex_chart_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../theme/shared/components/chart/apex-chart/apex-chart.service */ "./src/app/theme/shared/components/chart/apex-chart/apex-chart.service.ts");
...
var DashAnalyticsComponent = /** @class */ (function () {
    function DashAnalyticsComponent(apexEvent, _router) {
    ...
    DashAnalyticsComponent.prototype.sessionExpired = function () {
        localStorage.clear();
    ...
    DashAnalyticsComponent.ctorParameters = function () { return [
        { type: _theme_shared_components_chart_apex_chart_apex_chart_service__WEBPACK_IMPORTED_MODULE_4__["ApexChartService"] },
    ...
    DashAnalyticsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_theme_shared_components_chart_apex_chart_apex_chart_service__WEBPACK_IMPORTED_MODULE_4__["ApexChartService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]])
...
var ChartDB = /** @class */ (function () {
    ...
    ChartDB.supportCAC = {
        ...
        tooltip: {
            ...
            y: {
                title: {
                    formatter: function (seriesName) { return 'Ticket '; }
                }
            },
            marker: {
                show: false
    ...
    ChartDB.trafficMonitorCAC = {
        ...
        tooltip: {
            ...
            y: {
                title: {
                    formatter: function (seriesName) { return 'Click '; }
                }
            },
            marker: {
                show: false
    ...
    ChartDB.transactions1CAC = {
        ...
        tooltip: {
            ...
            y: {
                title: {
                    formatter: function (seriesName) { return 'Inbound'; }
                }
            },
            marker: {
                show: false
    ...
    ChartDB.transactions2CAC = {
        ...
        tooltip: {
            ...
            y: {
                title: {
                    formatter: function (seriesName) { return 'Outbound'; }
                }
            },
            marker: {
                show: false
    ...
    ChartDB.view1CAC = {
        ...
        tooltip: {
            ...
            y: {
                title: {
                    formatter: function (seriesName) { return 'Page view:'; }
                }
            },
            marker: {
                show: false
    ...
    ChartDB.view2CAC = {
        ...
        tooltip: {
            ...
            y: {
                title: {
                    formatter: function (seriesName) { return 'Users:'; }
                }
            },
            marker: {
                show: false
    ...
    ChartDB.line3CAC = {
        ...
        tooltip: {
            y: [{
                    title: {
                        formatter: function (val) { return val + ' (mins)'; }
                    }
                }, {
                    title: {
                        formatter: function (val) { return val + ' per session'; }
                    }
                }, {
                    title: {
